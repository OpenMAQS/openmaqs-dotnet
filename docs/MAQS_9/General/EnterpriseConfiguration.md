...
<configuration>
  ...
  <SeleniumMaqs>
    <!-- Root to website -->
    <add key="WebSiteBase" value="https://OpenMAQS.github.io/maqs-dotnet-templates/Static/Automation/" />
...
```json
{
  ...
  "SeleniumMaqs": {
    "WebSiteBase": "https://OpenMAQS.github.io/maqs-dotnet-templates/Static/Automation/",
    "Browser": "Chrome",
