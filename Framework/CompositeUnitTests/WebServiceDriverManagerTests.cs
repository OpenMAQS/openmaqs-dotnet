//--------------------------------------------------
// <copyright file="WebServiceDriverManagerTests.cs" company="OpenMAQS">
...
namespace CompositeUnitTests
{
    ...
    public class WebServiceDriverManagerTests : BaseWebServiceTest
    {
        ...
        public void CanUseMultiple()
        {
            ...
            Assert.AreNotEqual(this.TestObject.WebServiceDriver, this.ManagerStore.GetManager<WebServiceDriverManager>("test").Get());
